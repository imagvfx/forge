...
var testUpdateProps = []testProperty{
	...
	{path: "/test/shot/cg/0010", k: "due", v: "0", expect: time.Now().Local().Format("2006/01/02")},
	...
	{path: "/test/shot/cg/0010/ani", k: "chat", v: ">0001 how are you doing", expect: "\n*0001 admin@imagvfx.com 2000-01-01T00:00:00Z\n|hi\n|*0003 admin@imagvfx.com 2000-01-01T00:00:00Z\n||how are you doing\n*0002 admin@imagvfx.com 2000-01-01T00:00:00Z\n|hello"},
	{path: "/test/shot/cg/0010/ani", k: "chat", v: ">0000 good", want: errors.New("chat not found: 0000")},
	{path: "/test/shot/cg/0010/ani", k: "chat", v: ">0003 good", want: errors.New("cannot reply to a reply: 0003")},
	{path: "/test/shot/cg/0010/ani", k: "chat", v: "-0000", want: errors.New("chat not found: 0000")},
	{path: "/test/shot/cg/0010/ani", k: "chat", v: "-0003", expect: "\n*0001 admin@imagvfx.com 2000-01-01T00:00:00Z\n|hi\n*0002 admin@imagvfx.com 2000-01-01T00:00:00Z\n|hello"},
