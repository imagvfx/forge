...
func main() {
	...
	mux.HandleFunc("/", page.HandlerFunc(page.handleEntry))
	mux.HandleFunc("/logs", page.HandlerFunc(page.handleEntryLogs))
	mux.HandleFunc("/thumbnail/", page.HandlerFunc(page.handleThumbnail))
	mux.HandleFunc("/users", page.HandlerFunc(page.handleUsers))
	mux.HandleFunc("/groups", page.HandlerFunc(page.handleGroups))
	mux.HandleFunc("/types", page.HandlerFunc(page.handleEntryTypes))
	mux.HandleFunc("/api/add-entry-type", api.HandlerFunc(api.handleAddEntryType))
	mux.HandleFunc("/api/rename-entry-type", api.HandlerFunc(api.handleRenameEntryType))
	mux.HandleFunc("/api/delete-entry-type", api.HandlerFunc(api.handleDeleteEntryType))
	mux.HandleFunc("/api/add-default", api.HandlerFunc(api.handleAddDefault))
	mux.HandleFunc("/api/set-default", api.HandlerFunc(api.handleSetDefault))
	mux.HandleFunc("/api/delete-default", api.HandlerFunc(api.handleDeleteDefault))
	mux.HandleFunc("/api/add-entry", api.HandlerFunc(api.handleAddEntry))
	mux.HandleFunc("/api/rename-entry", api.HandlerFunc(api.handleRenameEntry))
	mux.HandleFunc("/api/delete-entry", api.HandlerFunc(api.handleDeleteEntry))
	mux.HandleFunc("/api/add-property", api.HandlerFunc(api.handleAddProperty))
	mux.HandleFunc("/api/set-property", api.HandlerFunc(api.handleSetProperty))
	mux.HandleFunc("/api/get-property", api.HandlerFunc(api.handleGetProperty))
	mux.HandleFunc("/api/delete-property", api.HandlerFunc(api.handleDeleteProperty))
	mux.HandleFunc("/api/add-environ", api.HandlerFunc(api.handleAddEnviron))
	mux.HandleFunc("/api/set-environ", api.HandlerFunc(api.handleSetEnviron))
	mux.HandleFunc("/api/get-environ", api.HandlerFunc(api.handleGetEnviron))
	mux.HandleFunc("/api/delete-environ", api.HandlerFunc(api.handleDeleteEnviron))
	mux.HandleFunc("/api/add-thumbnail", api.HandlerFunc(api.handleAddThumbnail))
	mux.HandleFunc("/api/set-thumbnail", api.HandlerFunc(api.handleUpdateThumbnail))
	mux.HandleFunc("/api/delete-thumbnail", api.HandlerFunc(api.handleDeleteThumbnail))
	mux.HandleFunc("/api/add-access", api.HandlerFunc(api.handleAddAccess))
	mux.HandleFunc("/api/set-access", api.HandlerFunc(api.handleSetAccess))
	mux.HandleFunc("/api/get-access", api.HandlerFunc(api.handleGetAccess))
	mux.HandleFunc("/api/delete-access", api.HandlerFunc(api.handleDeleteAccess))
	mux.HandleFunc("/api/add-group", api.HandlerFunc(api.handleAddGroup))
	mux.HandleFunc("/api/rename-group", api.HandlerFunc(api.handleRenameGroup))
	mux.HandleFunc("/api/add-group-member", api.HandlerFunc(api.handleAddGroupMember))
	mux.HandleFunc("/api/delete-group-member", api.HandlerFunc(api.handleDeleteGroupMember))
	mux.HandleFunc("/api/set-user-setting", api.HandlerFunc(api.handleSetUserSetting))
